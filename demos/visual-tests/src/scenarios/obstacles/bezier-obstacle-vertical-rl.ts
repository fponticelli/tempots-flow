...
export const bezierObstacleVerticalRLScenario: TestScenario = {
  id: 'obstacle--bezier-vertical-rl',
  name: 'Bezier Obstacle (Vertical RL)',
  category: 'obstacles',
  description: 'RL arrangement with vertical port placement, obstacle in between',
  graph: makeGraph(
    [
